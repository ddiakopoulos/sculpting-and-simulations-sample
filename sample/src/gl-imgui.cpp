...
// Implement singleton
template<> gui::imgui_app_state * singleton<gui::imgui_app_state>::single = nullptr;
...
namespace gui
{
    ...
    {
        imgui_app_state & state = imgui_app_state::get_instance();
        ...
        {
            imgui_app_state & s = imgui_app_state::get_instance();
    ...
    void imgui_manager::update_input(const app_input_event & e)
    {
        imgui_app_state & state = imgui_app_state::get_instance();
        ImGuiIO & io = ImGui::GetIO();
        ...
        if (e.type == app_input_event::Type::MOUSE)
        {
            ...
            {
                int button = clamp<int>( (int) e.value[0], 0, 3);
    ...
    bool imgui_manager::create_fonts_texture()
    {
        imgui_app_state & state = imgui_app_state::get_instance();
    ...
    bool imgui_manager::create_render_objects()
    {
        imgui_app_state & state = imgui_app_state::get_instance();
    ...
    void imgui_manager::destroy_render_objects()
    {
        imgui_app_state & state = imgui_app_state::get_instance();
